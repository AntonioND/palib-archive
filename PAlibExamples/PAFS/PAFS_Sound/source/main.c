...
int main(int argc, char ** argv){
	...
	// PA_PlayGBFSSimpleSound, PA_PlayGBFSSound, and PA_PlayGBFSSoundEx
		if (Pad.Newpress.A) PA_PlayFSSimpleSound(0, 0); // Sound channel and number in GBFS
		if (Pad.Newpress.B) PA_PlayFSSound(0, 0, 127, 11025); // Sound channel and number in GBFS, sound volume and rate...
