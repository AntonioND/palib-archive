...
#define PA16cPos(x, y) (((x>>3)*26*8) + y + 8)
...
int main(int argc, char ** argv)
{
	...
	PA_16cText(1, //screen 
					10, 0, 255, 20, //x1, y1, x2, y2 position
					"Hello World", //text
					1, //color (1-10)
					0, // text size (0-4)
					100); // maximum number of characters (use like 10000 if you don't know)
	PA_16cText(1, 10, 20, 255, 40, "Hello World", 1, 1, 100);
	...
	PA_16cText(0, 10, 20, 255, 40, "Hello World", 1, 3, 100);
	PA_16cText(0, 10, 40, 255, 60, "Hello World", 2, 3, 100);
	PA_16cText(0, 10, 60, 255, 80, "Hello World", 3, 3, 100);
	PA_16cText(0, 10, 80, 255, 100, "Hello World", 4, 3, 100);	
