...
/** @defgroup Fake Fake 16bit bitmap mode
...
/*! \def PA_ClearFake16bitBitmap(screen)
    \brief
...
/*! \def PA_DrawFake16bitRect(u8 screen, u16 x1, u16 y1, u16 x2, u16 y2, u16 color)
    ...
    \~\param color
         ...
         \~french Couleur de 15 bits.On peut utiliser la macro PA_RGB pour entrer les valeurs RGB...
*/
#define PA_DrawFake16bitRect(screen, x1, y1, x2, y2, color) {PA_DrawFake16bitLine(screen, x1, y1, x2, y1, color);\
