...
/*! \fn void PA_3DStartSpriteAnimEx(u8 screen, u16 sprite, s16 firstframe, s16 lastframe, s16 speed, u8 type, s16 ncycles)
    \brief
...
/*! \fn extern inline void PA_3DStartSpriteAnim(u8 screen, u16 sprite, s16 firstframe, s16 lastframe, s16 speed)
    \brief
         \~english Start a sprite animation. Once started, it continues on and on by itself until you stop it !
         \~french Démarre une animation de sprite. Une fois démarrée, elle continue tant qu'on ne l'arrête pas !
    \~\param sprite
    ...
    \~\param speed
         ...
         \~french Vitesse, en frames par seconde (fps). 1 signifie donc 1 image par seconde... 
*/
extern inline void PA_3DStartSpriteAnim(u16 sprite, s16 firstframe, s16 lastframe, s16 speed){
...
/*! \fn extern inline void PA_3DStopSpriteAnim(u8 screen, u16 sprite)
    \brief
    ...
    \~\param sprite
         ...
         \~french Numéro du sprite dans le systeme de sprite	
*/
extern inline void PA_3DStopSpriteAnim(u16 sprite)
{
	if (sprite3danims[sprite].play) n3Dspriteanims--;
	sprite3danims[sprite].play = 0;
}

/*! \fn extern inline void PA_3DSetSpriteAnimFrame(u8 screen, u16 sprite, u16 frame)
    \brief
...
*/
extern inline void PA_3DSetSpriteAnimFrame(u16 sprite, u16 frame)
{
...
/*! \fn extern inline u16 PA_3DGetSpriteAnimFrame(u8 screen, u16 sprite)
    \brief
    ...
    \~\param sprite
         ...
         \~french Numéro du sprite dans le systeme de sprite	 
*/
extern inline u16 PA_3DGetSpriteAnimFrame(u16 sprite)
{
...
/*! \fn extern inline void PA_3DSetSpriteAnimSpeed(u8 screen, u16 sprite, s16 speed)
    \brief
...
*/
extern inline void PA_3DSetSpriteAnimSpeed(u16 sprite, s16 speed)
{
	sprite3danims[sprite].speed = speed;
}

/*! \fn extern inline u16 PA_3DGetSpriteAnimSpeed(u8 screen, u16 sprite)
    \brief
    ...
    \~\param sprite
         ...
         \~french Numéro du sprite dans le systeme de sprite	
*/
extern inline u16 PA_3DGetSpriteAnimSpeed(u16 sprite)
{
	return sprite3danims[sprite].speed;
}


/*! \fn extern inline void PA_3DSetSpriteNCycles(u8 screen, u16 sprite, s16 NCycles)
    \brief
...
*/
extern inline void PA_3DSetSpriteNCycles(u16 sprite, s16 NCycles)
{
...
/*! \fn extern inline u16 PA_3DGetSpriteNCycles(u8 screen, u16 sprite)
    \brief
    ...
    \~\param sprite
         ...
         \~french Numéro du sprite dans le systeme de sprite	
*/
extern inline u16 PA_3DGetSpriteNCycles(u16 sprite)
{
	return sprite3danims[sprite].speed;
}
...
/*! \fn extern inline u16 PA_3DSpriteAnimPause(u8 screen, u16 sprite, u8 pause)
    \brief
...
*/
extern inline void PA_3DSpriteAnimPause(u16 sprite, u8 pause)
{
