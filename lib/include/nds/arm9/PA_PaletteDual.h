...
/*! \fn extern inline void PA_DualSetPalNeg(u32 palette)
    \brief
...
*/
extern inline void PA_DualSetPalNeg(u32 palette) {
u16* pal = (u16*)palette;
u16 i;
	for (i = 0; i < 256; i++) {
...
/*! \fn extern inline void PA_DualSetPal16Neg(u32 palette, u8 n_palette)
    \brief
...
*/
extern inline void PA_DualSetPal16Neg(u32 palette, u8 n_palette) {
u16* pal = (u16*)palette;
u16 i;
