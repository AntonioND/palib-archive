...
_REG32(0x4000008 + (0x1000 * screen) + (bg_select << 4)) = DX; // REG_BGXX
_REG32(0x400000C + (0x1000 * screen) + (bg_select << 4)) = DY; // REG_BGXY

_REG16(0x4000000 + (0x1000 * screen) + (bg_select << 4)) = PA;  //REG_BGXPA
_REG16(0x4000002 + (0x1000 * screen) + (bg_select << 4)) = PB;  //REG_BGXPB
_REG16(0x4000004 + (0x1000 * screen) + (bg_select << 4)) = PC;  //REG_BGXPC
_REG16(0x4000006 + (0x1000 * screen) + (bg_select << 4)) = PA;  //REG_BGXPD
}
