...
Folders:
  ...
  source/gfx - Contains PAGfx (a graphics converter) and the graphics for your program.
...
To use special features like MP3 playback or MaxMod you have to select an ARM7 core for your project.
You can do this in the Makefile - open it with an editor and read the first few lines.

The following features are available:

Sound / Music:
 MP3    - MP3 file playback using Noda's ASlib (Examples\Sound\ASlib\ASlib_General) - this is the default
 MaxMod - module playback (mod, s3m, xm and it) using eKid's MaxMod (it comes with devkitPro) 
...
/----------------------------------------------------------------------------------------------------------------------------------\
| IMPORTANT: Your project will only work on the G6 and M3 Real cards if you choose an ARM7 core which does not use a lot of space. |
