...
#define getIPC PA_getIPC
*s/

#define PA_IPC_compat ((PA_TransferRegion volatile *)(0x027FF000))
*/

#define PA_IPC_compat ((PA_TransferRegion volatile *)((0x027FF000+sizeof(TransferRegion))))
#endif
