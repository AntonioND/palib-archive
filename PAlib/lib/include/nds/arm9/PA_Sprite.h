...
typedef struct {
	...
	u8 drawsize;
	u32 *gfxpointer; // Pour dessiner à l'écran directement
} PA_DrawSprites;
*/
...
/*! \fn extern inline void PA_SetSpriteNCycles(u8 screen, u8 sprite, s32 NCycles)
    \brief
...
*/
extern inline void PA_SetSpriteNCycles(u8 screen, u8 sprite, s32 NCycles)
{
...
/*! \fn extern inline s32 PA_GetSpriteNCycles(u8 screen, u8 sprite)
    \brief
    ...
    \~\param sprite
         ...
         \~french Numéro du sprite dans le systeme de sprite	
*/
extern inline s32 PA_GetSpriteNCycles(u8 screen, u8 sprite)
{
