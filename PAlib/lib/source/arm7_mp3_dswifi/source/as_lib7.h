...
#include "SoundCommon.h"	// <PALIB-CHANGE>
...
#define IPC_Sound   ((IPC_SoundSystem*)((u32)(PA_IPC_compat) + sizeof(PA_TransferRegion) + sizeof(SND_CONTROL) + sizeof(MT_MSG_CMD))) // <PALIB-CHANGE>
