...
extern const unsigned char mario_world_Tiles[1536] __attribute__ ((aligned (4))) ;  // Pal : mario_world_Pal
...
extern const unsigned short mario_world_Pal[69] __attribute__ ((aligned (4))) ;
