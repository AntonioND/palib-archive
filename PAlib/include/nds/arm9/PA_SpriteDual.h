...
/*! \fn extern inline void PA_DualStartSpriteAnimEx(u8 sprite, s16 firstframe, s16 lastframe, s16 speed, u8 type, s16 ncycles)
    \brief
...
*/
extern inline void PA_DualStartSpriteAnimEx(u8 sprite, s16 firstframe, s16 lastframe, s16 speed, u8 type, s16 ncycles){
...
/*! \fn extern inline void PA_DualStartSpriteAnim(u8 sprite, s16 firstframe, s16 lastframe, s16 speed)
    \brief
    ...
    \param speed
         ...
         \~french Vitesse, en frames par seconde (fps). 1 signifie donc 1 image par seconde... 
*/
extern inline void PA_DualStartSpriteAnim(u8 sprite, s16 firstframe, s16 lastframe, s16 speed){
...
/*! \fn extern inline void PA_DualStopSpriteAnim(u8 sprite)
    \brief
    ...
    \param sprite
         ...
         \~french Numéro du sprite dans le systeme de sprite	
*/
extern inline void PA_DualStopSpriteAnim(u8 sprite)
{
...
/*! \fn extern inline void PA_DualSetSpriteAnimFrame(u8 sprite, u16 frame)
    \brief
...
*/
extern inline void PA_DualSetSpriteAnimFrame(u8 sprite, u16 frame)
{
...
/*! \fn extern inline u16 PA_DualGetSpriteAnimFrame(u8 sprite)
    \brief
    ...
    \param sprite
         ...
         \~french Numéro du sprite dans le systeme de sprite	 
*/
extern inline u16 PA_DualGetSpriteAnimFrame(u8 sprite)
{
...
/*! \fn extern inline void PA_DualSetSpriteAnimSpeed(u8 sprite, s16 speed)
    \brief
...
*/
extern inline void PA_DualSetSpriteAnimSpeed(u8 sprite, s16 speed)
{
...
/*! \fn extern inline u16 PA_DualGetSpriteAnimSpeed(u8 sprite)
    \brief
    ...
    \param sprite
         ...
         \~french Numéro du sprite dans le systeme de sprite	
*/
extern inline u16 PA_DualGetSpriteAnimSpeed(u8 sprite)
{
