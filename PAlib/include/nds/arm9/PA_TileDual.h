...
/*!
    \fn extern inline void PA_DualHideBg(u8 bg_select)
    \brief
...
*/
extern inline void PA_DualHideBg(u8 bg_select){
	PA_HideBg(0, bg_select);
	PA_HideBg(1, bg_select);	
}

/*!
    \fn extern inline void PA_DualShowBg(u8 bg_select)
    \brief
    ...
    \param bg_select
      ...
      \~french Numéro du fond que l'on veut charger (de 0 à 3 en mode 0, uniquement 2 et 3 en mode 2)
*/
extern inline void PA_DualShowBg(u8 bg_select){
...
/*!
    \fn extern inline void PA_DualDeleteBg(u8 bg_select)
    \brief
    ...
    \param bg_select
      ...
      \~french Numéro du fond que l'on veut charger (de 0 à 3 en mode 0, uniquement 2 et 3 en mode 2)
*/
extern inline void PA_DualDeleteBg(u8 bg_select){
...
/*!
    ...
    \brief
      \~english Simplest way to load a Background on both screens
      \~french Facon la plus simple de cahrger un fond sur les 2 écrans 
    \param bg_select
      \~english Background number to load (from 0 to 3)
      \~french Numéro du fond que l'on veut charger (de 0 à 3 en mode 0, uniquement 2 et 3 en mode 2)
    \param bg_tiles
...
extern inline void PA_DualSetBgRot(u8 bg_select, s32 x_scroll, s32 y_scroll, s32 x_rotcentre, s32 y_rotcentre, s16 bg_angle, s32 bg_zoom){
...
/*!
    \fn extern inline void PA_DualBGScrollX(u8 bg_number, s16 x)
    \brief
...
*/
extern inline void PA_DualBGScrollX(u8 bg_number, s16 x){
...
/*!
    \fn extern inline void PA_DualBGScrollY(u8 bg_number, s16 y)
    \brief
...
/*!
    \fn extern inline void PA_DualBGScrollXY(u8 bg_number, s16 x, s16 y)
    \brief
    ...
    \param y
      ...
      \~french Valeur Y à déplacer, verticalement...
*/
extern inline void PA_DualBGScrollXY(u8 bg_number, s16 x, s16 y) {
...
/*!
    ...
    \brief
      \~english Completely load and initialise a background with infinite scrolling (usefull if larger or wider than 512 pixels), on both screens
      \~french Charger et initialiser un fond pour le scrolling infini (pour les fonds de plus de 512 pixels de haut ou de large), sur les 2 écrans
    \param bg_select
      \~english Background number to load (from 0 to 3)
      \~french Numéro du fond que l'on veut charger (de 0 à 3 en mode 0, uniquement 2 et 3 en mode 2)
    \param bg_tiles
...
/*!
    ...
    \param x
      ...
      \~french Valeur X à déplacer
*/
extern inline void PA_DualInfLargeScrollX(u8 bg_select, s32 x){
...
/*!
    \fn extern inline void PA_DualInfLargeScrollY(u8 bg_select, s32 y)
    \brief
...
/*!
    \fn extern inline void PA_DualInfLargeScrollXY(u8 bg_select, s32 x, s32 y)
    \brief
    ...
    \param y
      ...
      \~french Valeur Y à déplacer	  
*/
extern inline void PA_DualInfLargeScrollXY(u8 bg_select, s32 x, s32 y){
	PA_DualInfLargeScrollX(bg_select, x);
	PA_DualInfLargeScrollY(bg_select, y);
}

/*!
    \fn extern inline void PA_DualLargeScrollX(u8 bg_select, s32 x)
    \brief
    ...
    \param x
      ...
      \~french Valeur X à déplacer
*/
extern inline void PA_DualLargeScrollX(u8 bg_select, s32 x){
...
/*!
    \fn extern inline void PA_DualLargeScrollXY(u8 bg_select, s32 x, s32 y)
    \brief
    ...
    \param y
      ...
      \~french Valeur Y à déplacer	  
*/
extern inline void PA_DualLargeScrollXY(u8 bg_select, s32 x, s32 y){
...
/*!
    \fn extern inline void PA_DualInitParallaxX(s32 bg0, s32 bg1, s32 bg2, s32 bg3)
    \brief
...
*/
extern inline void PA_DualInitParallaxX(s32 bg0, s32 bg1, s32 bg2, s32 bg3) {
...
/*!
    \fn extern inline void PA_DualInitParallaxY(s32 bg0, s32 bg1, s32 bg2, s32 bg3)
    \brief
      \~english Initialise Parallax Scrolling for multiple backgrounds, horizontaly. Chose the speed at which each background will scroll compared to the others. Then use PA_ParallaxScrollX to scroll...
      \~french Initialiser le Parallax Scrolling pour plusieurs fonds, horizontalement. Choix de la vitesse à laquelle les fonds vont défiler par rapport aux autres... Utiliser PA_ParallaxScrollX par la suite pour scroller
    \param bg0
    ...
    \param bg3
      ...
      \~french Idem, pour le Fond 3
*/
extern inline void PA_DualInitParallaxY(s32 bg0, s32 bg1, s32 bg2, s32 bg3) {
...
/*!
    \fn extern inline void PA_DualParallaxScrollX(s32 x)
    \brief
    ...
    \param x
      ...
      \~french Valeur X à déplacer
*/
extern inline void PA_DualParallaxScrollX(s32 x){
u8 i;
	for(i = 0; i < 4; i++) {
		if (PA_parallaxX[0][i])  {
			if(scrollpos[0][i].infscroll) PA_DualInfLargeScrollX(i, (PA_parallaxX[0][i] * x) >> 8); // Si bg en scrolling infini
			else PA_DualBGScrollX(i, (PA_parallaxX[0][i] * x) >> 8); // Sinon scrolling normal
		}
	}
}
...
/*!
    \fn extern inline void PA_DualParallaxScrollY(s32 y)
    \brief
      \~english Scroll the backgrounds
      \~french Déplacer les fonds activés pour le parallax...
    \param y
      ...
      \~french Valeur Y à déplacer
*/
extern inline void PA_DualParallaxScrollY(s32 y){
u8 i;
	for(i = 0; i < 4; i++) {
		if (PA_parallaxY[0][i])  {
			if(scrollpos[0][i].infscroll) PA_DualInfLargeScrollY(i, (PA_parallaxY[0][i] * y) >> 8); // Si bg en scrolling infini
			else PA_DualBGScrollY(i, (PA_parallaxY[0][i] * y) >> 8); // Sinon scrolling normal
		}
	}
}
...
/*!
    \fn extern inline void PA_DualParallaxScrollXY(s32 x, s32 y)
    \brief
      \~english Scroll the backgrounds
      \~french Déplacer les fonds activés pour le parallax...
    \param x
    ...
    \param y
      ...
      \~french Valeur Y à déplacer
*/
extern inline void PA_DualParallaxScrollXY(s32 x, s32 y){
...
/*!
    \fn extern inline void PA_DualSetBgPrio(u8 bg, u8 prio)
    \brief
...
*/
extern inline void PA_DualSetBgPrio(u8 bg, u8 prio) {
