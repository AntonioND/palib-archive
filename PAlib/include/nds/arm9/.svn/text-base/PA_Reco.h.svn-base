...
/*!
    \fn extern inline void PA_RecoAddShape(char letter, char *shape)
    \brief
...
*/
extern inline void PA_RecoAddShape(char letter, char *shape){

PA_CustomShape[PA_CustomReco].letter = letter;
u8 i;
for (i = 0; i < 16; i++) PA_CustomShape[PA_CustomReco].code[i] = shape[i];
PA_CustomReco++;
}
