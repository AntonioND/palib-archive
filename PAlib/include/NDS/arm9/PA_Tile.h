...
/*!
    \def PA_GetBGScrollX(screen, bg_number)
    \brief
      \~english Get the current horizontal scroll of any background
      \~french Récupérer le scroll horizontal de n'importe quel fond
    \param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'écran (0 ou 1)
    \param bg_number
...
/*!
    \def PA_GetBGScrollY(screen, bg_number)
    \brief
      \~english Get the current vertical scroll of any background
      \~french Récupérer le scroll vertical de n'importe quel fond
    \param screen
         \~english Chose de screen (0 or 1)
         \~french Choix de l'écran (0 ou 1)
    \param bg_number
